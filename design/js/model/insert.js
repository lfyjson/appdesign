define(function(require, exports, module) {
    var Model = require('./data'); /*加载model*/
    var Templates = require('../view/phone').Templates; /*加载控件模板*/
    var m = require('../tools/method');
    var Search = require('./search');
    var db = require('../controller/databind');

    var modifiable = ['text', 'textarea', 'number'].join(""); /*可更改提示的类型*/
    ...
    function insertNewItem(obj) {
        ...
        var type = obj.dataset.type; //控件类型
        var id = Model.getNewId(); //获取新控件id
        ...
        if (type == 'dateRange') {
            ...
            title = obj.innerText || obj.textContent; //控件标题
        }
